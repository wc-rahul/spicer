...
class PredictiveSearchComponent extends Component {
  ...
  #resizeObserver = new ResizeObserver((entries) => {
    ...
    if(document.querySelectorAll('.header-overlay,.predictive-search-empty-state__close-button')) document.querySelectorAll('.header-overlay,.predictive-search-empty-state__close-button').forEach(function(close){
      close.addEventListener('click', function(e){
        e.preventDefault();
        e.stopImmediatePropagation();
        close.closest('body')?.querySelector('predictive-search-component')?.classList.remove('predictive-search--expanded');
      });
    });
  });
